...
public static void main(String[] args) throws SQLException {
		...
		MathResultat m = new MathResultat ("4+3", 7);
...
private static void testExpressions() {
	...
	try {
		...
		int Resultat = Saisie.saisieEntier("Saisir un résultat : ");
		int Id = Saisie.saisieEntier("Saisir un id : ");
		...
		MathResultat eNew = new MathResultat(Expression,Resultat,Id);
        ...
        Resultat = Saisie.saisieEntier("Saisir un nouveau résultat : ");
	...
	private static void afficheExpressions() throws SQLException {
